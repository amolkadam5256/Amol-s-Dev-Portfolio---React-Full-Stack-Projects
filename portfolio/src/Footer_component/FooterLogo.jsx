            ...
            <div className="lg:flex lg:items-center lg:justify-between">
                <section className="py-[70px] mt-0 lg:mt-5 ml-0 md:ml-10">
                    <div className="mx-auto px-4 sm:container">
                        <div className="border-stroke dark:border-dark-3 flex items-center pb-6">
                            ...
                            <div>
                                <h4 className="text-white mb-1 text-[1.5rem] font-semibold">
                                    Hey Amol Kadam 👋
                                </h4>
                                <p className="text-white text-lg font-medium w-[100%] md:w-[70%]">
                ...
                <div className="flex justify-start lg:justify-end mt-6 lg:mt-0 mr-0 md:mr-20">
