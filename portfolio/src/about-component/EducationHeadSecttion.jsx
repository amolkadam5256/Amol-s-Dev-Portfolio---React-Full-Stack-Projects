...
const EducationHeadSecttion = () => {
    return (
        <>
            <div className='relative md:flex block md:justify-start justify-center py-10 text-white border-b-0'>
                ...
                <div className='flex relative justify-center md:w-1/2 w-full md:mt-24 mt-10'>
                        ...
                        <div className='flex justify-center'>
                            <div className='grid grid-cols-5 md:grid-cols-5 lg:grid-cols-5 gap-5 mt-10 items-center justify-items-center'>
                                {[
                                    ...
                                    <div key={label} className='relative flex flex-col items-center justify-center transition-transform transform hover:scale-110 group text-white'>
