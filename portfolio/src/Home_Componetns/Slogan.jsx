        ...
        >
            {sloganText.map((text, index) => (
                <h2
                    ...
                    data-aos-offset="200"
                    className="relative text-[130px] md:text-[300px] lg:text-[480px] select-none py-0 tracking-[5px] md:tracking-[10px] lg:tracking-[20px] outline-red-600 uppercase font-extrabold text-black transition-colors font-[anzo1] leading-[200px] md:leading-[400px] lg:leading-[600px] text-center animate-fade"
                >
                    {text}
                </h2>
            ))}
